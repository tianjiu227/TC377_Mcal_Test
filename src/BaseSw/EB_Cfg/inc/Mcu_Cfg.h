...
**  VERSION   : 22.0.0                                                         **
**                                                                            **
**  DATE, TIME: 2023-08-21, 14:36:17         !!!IGNORE-LINE!!!                **
**                                                                            **
...
/*
  Configuration : MCU_STDBY_SET_API
  Preprocessor switch to enable / disable the use of the
  API Mcu_VextStdbyCtrl()
  ENABLED  : Mcu_VextStdbyCtrl API is available
  DISABLED : Mcu_VextStdbyCtrl API is not available
*/
#define MCU_STDBY_SET_API (STD_OFF)
/*
