...
{
  /* Physical index value for Sequence SpiSequence_qspi0_MCU2 Sequence ID 0 */
  0U,
    /* Physical index value for Sequence SpiSequence_QSPI2_35584 Sequence ID 1 */
  1U,
    /* Physical index value for Sequence SpiSequence_QSPI4_9183QK Sequence ID 2 */
  2U  
};
...
{
  /* Physical index value for channel SpiChannel_QSPI0_MCU2 channel ID 0 */
  0U,
    /* Physical index value for channel SpiChannel_QSPI2_TLF35584 channel ID 1 */
  1U,
    /* Physical index value for channel SpiChannel_QSPI4_TLE9183QK channel ID 2 */
  2U  
};

  /* Linked list for the Job[s] assigned to the sequence[s] Physical*/

static const Spi_JobType SpiSequence_qspi0_MCU2_JobLinkPtr_Physical[] =
{
...
static const Spi_JobType SpiSequence_QSPI2_35584_JobLinkPtr_Physical[] =
{
...
static const Spi_JobType SpiSequence_QSPI4_9183QK_JobLinkPtr_Physical[] =
{
...
{
  0U, /* Physical index value for Channel SpiChannel_QSPI0_MCU2 Channel ID 0 */
...
{
  1U, /* Physical index value for Channel SpiChannel_QSPI2_TLF35584 Channel ID 1 */
...
{
  2U, /* Physical index value for Channel SpiChannel_QSPI4_TLE9183QK Channel ID 2 */
...
static const Spi_SequenceConfigType Spi_kSequenceConfig_Core0[] =
{
  ...
  /* Sequence:SpiSequence_qspi0_MCU2 */
  {
    SpiConf_SpiSequence_SpiSequence_qspi0_MCU2,
    /* Job linked list */
    SpiSequence_qspi0_MCU2_JobLinkPtr_Physical,
    /* No. of jobs in Seq */
    1U,
    ...
    /* Sequence:SpiSequence_QSPI2_35584 */
  {
    ...
    /* Job linked list */
    SpiSequence_QSPI2_35584_JobLinkPtr_Physical,
    /* No. of jobs in Seq */
    1U,
    ...
    /* Synchronous Sequence[s] */
    /* Sequence:SpiSequence_QSPI4_9183QK */
  {
    SpiConf_SpiSequence_SpiSequence_QSPI4_9183QK,
    /* Job linked list */
    SpiSequence_QSPI4_9183QK_JobLinkPtr_Physical,
    /* No. of jobs in Seq */
    1U,
...
static const Spi_ChannelConfigType Spi_kChannelConfig_Core0[] =
{
  ...
  /* Channel:SpiChannel_QSPI0_MCU2 */
  {
    ...
    SpiConf_SpiChannel_SpiChannel_QSPI0_MCU2
  },
...
{
  {0, 0},    /*SpiChannel_QSPI0_MCU2*/
  {0, 0},    /*SpiChannel_QSPI2_TLF35584*/
  {0, 0},    /*SpiChannel_QSPI4_TLE9183QK*/
  {0xFFFF, 0xFFFF}
};
