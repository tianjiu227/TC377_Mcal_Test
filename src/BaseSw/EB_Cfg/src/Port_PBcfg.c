...
**  VERSION   : 14.0.0                                                        **
**                                                                            **
**  DATE, TIME: 2023-09-04, 14:15:22          !!!IGNORE-LINE!!!               **
**                                                                            **
...
static const Port_n_ConfigType Port_kConfiguration[] =
{
  /*                              Port0                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_OPENDRAIN | PORT_PIN_MODE_ALT1),/*Pin 2*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ...
    Portx_lPdrConfig1(
      (PORT_PIN_PAD_LEVEL_DEFAULT|FAST_PORT_PIN_STRONG_DRIVER_SHARP_EDGE),/*Pin0*/
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_OPENDRAIN | PORT_PIN_MODE_ALT1),/*Pin2*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT1),/*Pin6*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT1),/*Pin8*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
  ...
  /*                              Port2                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT1),/*Pin9*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT1),/*Pin10*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_PULL_UP | PORT_PIN_MODE_GPIO),/*Pin11*/
  ...
  /*                              Port15                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT3),/*Pin3*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_PULL_UP | PORT_PIN_MODE_GPIO),/*Pin4*/
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT3),/*Pin5*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_PULL_UP | PORT_PIN_MODE_GPIO),/*Pin6*/
  ...
  /*                              Port20                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT3),/*Pin13*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
  ...
  /*                              Port22                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_OUT | PORT_PIN_OUT_PUSHPULL | PORT_PIN_MODE_ALT3),/*Pin0*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_PULL_UP | PORT_PIN_MODE_GPIO),/*Pin1*/
  ...
  /*                              Port40                       */
  {
    ...
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_NO_PULL | PORT_PIN_MODE_GPIO),/*Pin5*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_NO_PULL | PORT_PIN_MODE_GPIO),/*Pin6*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
      ((uint8)PORT_PIN_IN | PORT_PIN_IN_NO_PULL | PORT_PIN_MODE_GPIO),/*Pin7*/
    /* MISRA2012_RULE_10_3_JUSTIFICATION: The port IOCR registers has the
    control bit field for each port pin located  as register bytes. Hence
    typecasting is done for each port pin to uint8*/
