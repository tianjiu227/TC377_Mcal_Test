...
/*Function declaration for Notification Function of AdcGroup_G0SW*/
...
/*Function declaration for Notification Function of AdcGroup_G2SW*/
extern void IoHwAb_AdcNotification65(void);
/*Function declaration for Notification Function of AdcGroup_G3SW*/
extern void IoHwAb_AdcNotification96(void);
/*Function declaration for Notification Function of AdcGroup_G8SW*/
extern void IoHwAb_AdcNotification257(void);
/*Function declaration for Notification Function of AdcGroup_G10SW*/
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines. */ 
#include "Adc_MemMap.h"
/**Group Definition of AdcGroup_G0SW- ID1 of HW Unit 0 */
static const Adc_GroupDefType Adc_kHwUnit0GrpAdcGroup_G0SW_Config[3]=
{
  /*AS Logical Channel*/ /*Analog Channel*/ /*Result Register*/ /*Channel Diagnostic Data*/
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines. */ 
#include "Adc_MemMap.h"
/**Group Definition of AdcGroup_G2SW- ID65 of HW Unit 2 */
static const Adc_GroupDefType Adc_kHwUnit2GrpAdcGroup_G2SW_Config[2]=
{
  /*AS Logical Channel*/ /*Analog Channel*/ /*Result Register*/ /*Channel Diagnostic Data*/
        {  1U,                   1U,                1U,                0x00000000U},
        {  2U,                   2U,                2U,                0x00000000U}
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines. */ 
#include "Adc_MemMap.h"
/**Group Definition of AdcGroup_G3SW- ID96 of HW Unit 3 */
static const Adc_GroupDefType Adc_kHwUnit3GrpAdcGroup_G3SW_Config[2]=
{
  /*AS Logical Channel*/ /*Analog Channel*/ /*Result Register*/ /*Channel Diagnostic Data*/
        {  0U,                   0U,                0U,                0x00000000U},
        {  1U,                   1U,                1U,                0x00000000U}
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines. */ 
#include "Adc_MemMap.h"
/**Group Definition of AdcGroup_G8SW- ID256 of HW Unit 8 */
static const Adc_GroupDefType Adc_kHwUnit8GrpAdcGroup_G8SW_Config[6]=
{
  /*AS Logical Channel*/ /*Analog Channel*/ /*Result Register*/ /*Channel Diagnostic Data*/
        {  0U,                   0U,                0U,                0x00000000U},
        {  1U,                   1U,                1U,                0x00000000U},
        {  4U,                   4U,                2U,                0x00000000U},
        {  2U,                   5U,                3U,                0x00000000U},
        {  3U,                   6U,                4U,                0x00000000U},
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines. */ 
#include "Adc_MemMap.h"
/**Group Definition of AdcGroup_G10SW- ID320 of HW Unit 10 */
static const Adc_GroupDefType Adc_kHwUnit10GrpAdcGroup_G10SW_Config[2]=
{
  /*AS Logical Channel*/ /*Analog Channel*/ /*Result Register*/ /*Channel Diagnostic Data*/
        {  1U,                   0U,                0U,                0x00000000U},
        {  0U,                   6U,                1U,                0x00000000U}
};
/* MISRA2012_RULE_5_1_JUSTIFICATION: Memmap macros are defined as per Autosar
   naming convention, hence it goes beyond 32 characters.*/
/* MISRA2012_RULE_5_2_JUSTIFICATION: Memmap macros are defined as per Autosar
...
static const Adc_GroupCfgType Adc_kHwUnit0Grp_Config[2]=
{
  ...
  {/*Group Configuration structure for AdcGroup_G0SW - ID1*/
    /*
      Group Properties:
    ...
    */
    ...
    /*Address for Group Definition Structure*/
    &Adc_kHwUnit0GrpAdcGroup_G0SW_Config[0U],
    /*Address for the GTM trigger configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
    /*Address for the GTM gate configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
...
static const Adc_GroupCfgType Adc_kHwUnit2Grp_Config[2]=
{
  ...
  {/*Group Configuration structure for AdcGroup_G2SW - ID65*/
    /*
      Group Properties:
      Trigger Source: ADC_TRIGG_SRC_SW
      Trigger Edge: 
    ...
    */
    ...
    /*Address for Group Definition Structure*/
    &Adc_kHwUnit2GrpAdcGroup_G2SW_Config[0U],
    /*Address for the GTM trigger configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
    /*Address for the GTM gate configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
...
static const Adc_GroupCfgType Adc_kHwUnit3Grp_Config[1]=
{
  ...
  {/*Group Configuration structure for AdcGroup_G3SW - ID96*/
    /*
      Group Properties:
      Trigger Source: ADC_TRIGG_SRC_SW
      Trigger Edge: 
    ...
    */
    ...
    /*Address for Group Definition Structure*/
    &Adc_kHwUnit3GrpAdcGroup_G3SW_Config[0U],
    /*Address for the GTM trigger configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
    /*Address for the GTM gate configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
...
static const Adc_GroupCfgType Adc_kHwUnit8Grp_Config[1]=
{
  ...
  {/*Group Configuration structure for AdcGroup_G8SW - ID256*/
    /*
      Group Properties:
      Trigger Source: ADC_TRIGG_SRC_SW
      Trigger Edge: 
    ...
    */
    ...
    /*Address for Group Definition Structure*/
    &Adc_kHwUnit8GrpAdcGroup_G8SW_Config[0U],
    /*Address for the GTM trigger configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
    /*Address for the GTM gate configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
...
static const Adc_GroupCfgType Adc_kHwUnit10Grp_Config[1]=
{
  ...
  {/*Group Configuration structure for AdcGroup_G10SW - ID320*/
    /*
      Group Properties:
      Trigger Source: ADC_TRIGG_SRC_SW
      Trigger Edge: 
    ...
    */
    ...
    /*Address for Group Definition Structure*/
    &Adc_kHwUnit10GrpAdcGroup_G10SW_Config[0U],
    /*Address for the GTM trigger configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
    /*Address for the GTM gate configuration structure*/
    (const Mcu_17_Gtm_TomAtomChConfigType *)0U,
