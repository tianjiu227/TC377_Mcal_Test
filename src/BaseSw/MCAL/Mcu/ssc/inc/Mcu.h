...
/* MCU_E_PARAM_STDBY  */
/* [cover parentID={1ADB27A9-8D6F-41c8-B1B8-6E52236B60CF}][/cover] */
/* If Input value passed is not valid for API Mcu_VextStdbyCtrl*/
#define MCU_E_PARAM_STDBY             ((uint8)22U)
...
/* Service ID for Mcu_VextStdbyCtrl */
#define MCU_SID_VEXTSTDBYCTRL           ((uint8)91U)
...
typedef struct
{
  ...
  /*Variable to store GTM CMU clock source selection*/
  uint32            GtmCmuClkCtrl;
...
**                                                                            **
*******************************************************************************/
extern void Mcu_VextStdbyCtrl
(
const uint8 SetValue
);
#else
/*MISRA2012_RULE_4_9_JUSTIFICATION:Function like macro is used to generate
  compilation error, when an optional function is called by application
  and not enabled in the configuration*/
#define Mcu_VextStdbyCtrl(SetValue)\
                          ERROR_Mcu_VextStdbyCtrl_API_IS_NOT_SELECTED
#endif
