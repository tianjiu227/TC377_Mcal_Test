...
#if ( ICU_17_TIMERIP_SW_MINOR_VERSION != 40U )
  ...
  const Icu_17_TimerIp_ChannelConfigType *const LocalIcuChanPtr)
{
  ...
  {
    case (uint32)ICU_17_TIMERIP_MODE_SIGNAL_MEASUREMENT:
      /* Mode is configured in Signal measurement */
  ...
  const Icu_17_TimerIp_ChannelConfigType *const LocalIcuChanPtr)
{
  ...
  EruLineUsed = (((uint8) HwUsed) & ICU_ERU_CHNL_MASK);
   /* Check the status in EIFR register for respective Eru channel for which
  FMR register cleared in Icu_lEruInit */ 
  EIFRStatus = (uint8)((((uint32)MODULE_SCU.EIFR.U)>>EruLineUsed)&
                                            ((uint32)1UL));
  ...
  Is Compare value equal to 0xFFFFFFFF and EIFR status for selected channel 
  equal to Zero? [/cover] */
  if((CmpVal == ICU_INITCHECK_NO_ERR_VAL) && (EIFRStatus==(uint8)0UL))
  {
    ErrorFlag = E_OK;
  }
  return ErrorFlag;
  ...
  const Icu_17_TimerIp_ChannelConfigType *const LocalIcuChanPtr)
{
 ...
 EruLineUsed = (((uint8) HwUsed) & ICU_ERU_CHNL_MASK);
  ...
  /* Clear the service request in FMR for selected channel */
  MODULE_SCU.FMR.U = (((uint32) 1UL) << (EruLineUsed + ICU_ERU_FCSTART));
}
#endif
  ...
  uint32* const GlbIndexStatusPtr)
{
   ...
   * by violating this MISRA rule. */
  TimChannelRegPtr = GTM_TIM_CH_POINTER(ModuleNo, ChannelNo);
  /* Read Tim channel Interrupt notification register */
  NotifyValue = TimChannelRegPtr->IRQ.NOTIFY.U;

  /* Set the ICU_ACTIVITY_STARTED flag */
  if(1U == (NotifyValue & ICU_GTM_TIM_NEWVAL_MASK))
  {
    /* Clear NEWVAL flag */
    TimChannelRegPtr->IRQ.NOTIFY.U = ICU_GTM_NEWVAL_FLAG_SET;
    Mcal_SetBitAtomic( \
        GlbIndexStatusPtr, (sint32)ICU_CHNL_STATUS_POS,\
...
**                      uint32* const GlbIndexStatusPtr  )                    **
**                                                                            **
** Description :     Function to enable the interrupt required for            ** 
**                   a GPT12 channel                                          **
** [/cover]                                                                   **
**                                                                            **
** Service ID:       None                                                     **
  ...
  uint32* const GlbIndexStatusPtr)
{
  ...
  /* Read timer Tx register */
  TxRegValue = Gpt12TxRegPtr->U;
  
  /* Set timer Tx register to 0xFFFF to receive interrupt on every edge */
  ...
  uint32 *const GblIndexStatusPtr)
{
  ...
  /* Enter Critical Section */
  SchM_Enter_Icu_17_TimerIp_CcuGetTimeElapsed();
  ...
  CcuRRegVal = (uint16)CcuRRegPtr[CcChannelNumber].U;
   ...
   /* Exit Critical Section */
  SchM_Exit_Icu_17_TimerIp_CcuGetTimeElapsed();
  ...
  uint32* const GlbIndexStatusPtr)
{
  ...
  Are the notifications disabled?
  [/cover] */
  if(1U != Mcal_GetBitAtomic(*GlbIndexStatusPtr,
                        ICU_CHNL_NOTIF_PRESENCE_POS, ICU_CHNL_NOTIF_BIT_LENGTH))
  {
    /* Read TIM channel interrupt notification register */
    /* [cover parentID={146C0E64-B038-4e7e-B7FB-4B9AD79B9455}]
    Read TIM channel interrupt notification register.
    [/cover] */
    NotifyValue = TimChannelRegPtr->IRQ.NOTIFY.U;
  ...
  const uint8 Mode)
{
  ...
  {
    /* [cover parentID={D9D6FD08-6D13-4757-875E-D03FA3253CFC}]
     Read timer count register
     [/cover] */
    /* Read timer count register */
    IcuTxRegValue = Gpt12TxRegPtr->U;
    /* [cover parentID={67BDC29F-1BD5-4a0a-A92F-8EACF07EA0E9}]
     If there is any valid edge detected
     [/cover] */
    if (IcuTxRegValue > 0U)
    {
      /* Clear Timer Tx register Counter value */
      Gpt12TxRegPtr->U = 0U;
  ...
  uint32* const GlbIndexStatusPtr)
{
                           ...
                           ICU_CHNL_ACTIVITY_BIT_LENGTH))
  {
    ...
    {
      /* Read Tim Channel Notification Register */
      NotifyValue = TimChannelRegPtr->IRQ.NOTIFY.U;  
      ...
      {
        /* Clear NEWVAL interrupt flag before enabling */
        TimChannelRegPtr->IRQ.NOTIFY.U =  ICU_GTM_NEWVAL_FLAG_SET;
  ...
  const Icu_17_TimerIp_ChannelConfigType *const LocalIcuChanPtr)
{
  ...
  CcuRRegPtr = &(Ccu6RegPtr->CC6R[0]);
  /* Enter Critical Section */
  SchM_Enter_Icu_17_TimerIp_CcuGetDutyCycle();
  /* Read SR and R register values */
  CcuSrRegVal = (uint16)CcuSrRegPtr[CcChannelNumber].U;
  CcuRRegVal = (uint16)CcuRRegPtr[CcChannelNumber].U;
  /* Exit Critical Section */
  SchM_Exit_Icu_17_TimerIp_CcuGetDutyCycle();
  {
     ...
     const Icu_17_TimerIp_ChannelConfigType * const LocalIcuChanPtr)
{
...
#if (ICU_17_TIMERIP_SAFETY_ENABLE == STD_ON)
  /* Read TxCON register*/
  TxEdgeValue = Gpt12TxConRegPtr->U;
  ...
  /* [cover parentID={A2ADE720-A2FC-4a73-B69E-ACB0EB415602}]
    Is TxEDGE bit set?
  [/cover] */
  if((TxEdgeValue & ICU_GPT12_TxEDGE_MASK) != 0U)
#endif
  {
#if (ICU_17_TIMERIP_SAFETY_ENABLE == STD_ON)
    TxEdgeValue &= ~ICU_GPT12_TxEDGE_MASK;
    /* Clear TxEDGE bit */
    (Gpt12TxConRegPtr->U) = TxEdgeValue;
#endif
